...
import './App.scss';
import { FontContext, FontProvider } from './contexts/font.context';
...
import { FontType, Theme } from './constants';
        ...
        <ThemeContext.Consumer>
          {({ theme }) => (
            <FontContext.Consumer>
              {({ font }) => (
                <div className={`${theme === Theme.Dark ? 'dark' : ''} min-h-screen ${FontMap[font as keyof typeof FontType]}`}>
